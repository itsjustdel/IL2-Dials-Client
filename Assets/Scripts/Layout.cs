...
public class Layout
{
    ...
    public List<Vector2> oilTempPos = new List<Vector2>() { Vector2.zero, Vector2.zero, Vector2.zero, Vector2.zero };
    ...
    public List<float> oilTempScale = new List<float>() { -1f, -1f, -1f, -1f };
    ...
    public List<bool> oilTempInTray = new List<bool>() { false, false, false, false };
