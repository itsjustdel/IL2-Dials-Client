...
public class UDPClient : MonoBehaviour
{
    ...
    void ProcessPackage(byte[] bytes)
    {
        ...
        if (!testPrediction)
        {
            ...
            airplaneData.fuel[0] = floats[38]; //date in celsius in game
            airplaneData.fuel[1] = floats[39];
            airplaneData.fuel[2] = floats[40];
            airplaneData.fuel[3] = floats[41];
        }
